...
| **Внешний каталог** | Отсутствует | **628 000+ треков** с 12 акустическими параметрами (113 000+ артистов) |
...
| `POST` | `/api/v1/catalog/blend` | Поиск 12D кандидатов в каталоге (628k+) по акустическим свойствам |
