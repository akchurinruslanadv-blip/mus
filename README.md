...
| **Внешний каталог** | Отсутствует | **3 270 000+ треков** с 12 акустическими параметрами (323 000+ артистов) |
...
| `POST` | `/api/v1/catalog/preindex-512` | Фоновый 512D-майнинг и оцифровка топ-рекомендаций под персональный вкус |
| `GET` | `/api/v1/catalog/preindex-status` | Статус воркера фоновой 512D-индексации и счётчик векторов |
