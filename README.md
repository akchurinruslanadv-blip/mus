...
| **Внешний каталог** | Отсутствует | **2 390 000+ треков** с 12 акустическими параметрами (283 000+ артистов) |
...
| `POST` | `/api/v1/catalog/blend` | Поиск 12D кандидатов в каталоге (2.39M+) по акустическим свойствам |
